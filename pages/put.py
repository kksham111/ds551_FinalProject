...
def main():
    ...
    with c_up:
        with st.form("myForm"):
            ...
            columnName = st.text_input('Column Name for partitions:', key="ColumnName")
    ...
    if submitted:
        ...
        if uploadedFileCount % 2 == 0:
            ...
            for i in keys:
                ...
                ##Data
                res3 = requests.patch(baseURL2 + "/Data/" + joinedStr + "/.json",
        ...
        # print(len(data))
            ...
            client = MongoClient(
                "mongodb+srv://DSCI551Project:Dsci551@cluster0.2sh73fu.mongodb.net/?retryWrites=true&w=majority")
